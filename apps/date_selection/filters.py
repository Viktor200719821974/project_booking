...
class DateFilter(filters.FilterSet):
    ...
    class Meta:
        ...
        fields = ('date_departure_lt', 'date_departure_lte', 'date_departure_gt', 'date_departure_gte', 'date_departure',
                  'date_arrival_gte', 'date_arrival_gt', 'date_arrival_lte', 'date_arrival_lt', 'apartment_id',
                  'date_arrival')
